...
do
    ...
    --master_port $master_port train_net.py --config-file $config_file --seed $seed OUTPUT_DIR $output_dir SOLVER.MAX_EPOCH 30 SOLVER.LR 0.0001 SOLVER.BATCH_SIZE 64 TEST.BATCH_SIZE 64 MODEL.ARCHITECTURE $method
done
