...
#
for seed in {0..0}
#for seed in {0..9} # For fairer evaluation
...
do
    ...
    --master_port $master_port train_net.py --config-file $config_file --seed $seed OUTPUT_DIR $output_dir SOLVER.MAX_EPOCH 25 SOLVER.LR 0.0001 SOLVER.BATCH_SIZE 32 TEST.BATCH_SIZE 32 MODEL.ARCHITECTURE $method
done
